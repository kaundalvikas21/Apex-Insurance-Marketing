...
<section class="pt-6 pb-14 md:pb-16">
  <div class="container-ax">
    ...
    <div class="mt-8 max-w-3xl">
      ...
      <p class="reveal mt-4 ital-line">Ask us anything. We will answer it plainly.</p>
    ...
    <div class="mt-12 grid lg:grid-cols-12 gap-10 lg:gap-8 items-start">
      ...
      <div class="lg:col-span-5">
        ...
        <div class="reveal mt-8">
          <h2 class="text-h3-serif">What to expect on the call</h2>
          <ul class="mt-6 grid gap-5">
            <li class="flex items-start gap-3">
              {icon("clock", 22, "shrink-0 text-forest mt-1")}
              <div>
                <p class="font-semibold text-forest">Ten to twenty minutes</p>
                <p class="mt-1 text-ink">Longer if you want to work through the numbers, shorter if you already know what you want.</p>
              </div>
            </li>
            <li class="flex items-start gap-3">
              {icon("list-checks", 22, "shrink-0 text-forest mt-1")}
              <div>
                <p class="font-semibold text-forest">Questions, then options</p>
                <p class="mt-1 text-ink">Your age, state, health, and what you are trying to cover. No Social Security number and no credit check to get a quote.</p>
              </div>
            </li>
            <li class="flex items-start gap-3">
              {icon("handshake", 22, "shrink-0 text-forest mt-1")}
              <div>
                <p class="font-semibold text-forest">No pressure to decide on the call</p>
                <p class="mt-1 text-ink">If the honest answer is that you do not need what you called about, we will say so.</p>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div class="lg:col-span-6 lg:col-start-7">
        <div class="panel reveal">
          <h2 class="text-h3-serif">Send us a message</h2>
          ...
          <div id="contact-success" class="success">
            <div class="flex items-start gap-3">
              ...
              <div>
                <h3 class="text-h3-serif">Message received</h3>
  ...
  <div class="container-ax">
    <div class="reveal grid lg:grid-cols-12 gap-8 lg:gap-10 items-start">
      <div class="lg:col-span-5 flex items-start gap-3">
        {icon("shield-check", 26, "shrink-0 text-forest mt-1")}
        <h2 class="text-h3-serif">Licensed, and independent of every carrier</h2>
      </div>
...
<section class="section-tight band">
  <div class="container-ax">
    ...
    <!-- [SET HONEST SLA] Replace C.SLA with the response time the agency can
         actually hold to, including on a Friday afternoon. -->
    <div class="mt-10 grid md:grid-cols-3 gap-10 md:gap-8" data-stagger>
      {C.step(1, "You send it", "Your message goes to our agency inbox. It is not sold, shared, or passed to a lead broker.")}
      {C.step(2, "A licensed agent reads it", "A person, with a licence number, who can actually place the policy. Not a receptionist taking a message.")}
      {C.step(3, "We contact you", f"Within {C.SLA}, by whichever of phone or email you seem to prefer.", "If we are going to be slower than that, we will tell you rather than let it drift.")}
    </div>
  </div>
</section>
    ...
    <div class="grid lg:grid-cols-12 gap-10 lg:gap-8">
      ...
      <div class="lg:col-span-7 lg:col-start-6 reveal">
        <details class="acc" name="contact-faq">
          ...
          <div class="acc-body"><p class="text-ink">
