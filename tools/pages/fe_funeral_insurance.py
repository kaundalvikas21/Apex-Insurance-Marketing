...
FUNERAL_COST = """<h3 class="reveal text-h4">What decides the premium</h3>
...
{C.page_hero(
    TRAIL,
    "Funeral Insurance",
    'Funeral insurance is a small whole life policy that pays your family a cash sum to '
    'cover a funeral and the bills that follow.',
    answer=(
